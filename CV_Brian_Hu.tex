...
\begin{itemize}
  ...
  \subitem$\bullet$ Explainable AI (XAI), human machine teaming, image retrieval, anomaly detection
  \subitem$\bullet$ Person/vehicle re-identification, small object detection
