...
\item \textbf{Allen Institute for Brain Science}, Seattle, WA
  \subitem Scientist II, January 2020 - present
...
% \item \restitle{\textbf{Computational Neuroscience Laboratory}, Graduate Research Assistant}{Jun 2012--Nov 2017}
% \begin{itemize}
% \item Advisor: Dr. Ernst Niebur (Johns Hopkins University)
% \item Developed models of object-based vision and attention related to 3D surface perception, visual saliency, contour detection, and figure-ground segmentation
% \end{itemize}
...
\begin{enumerate}[resume]
\item \bibentry{Siegle_etal19}
\item \bibentry{Hu_etal19Memory}
\item \bibentry{Wagatsuma_etal19}
\end{enumerate}
